...
public class LocationActivity extends AppCompatActivity {
    public String[] states = {"Andhra Pradesh", "Arunachal Pradesh", "Assam", "Bihar", "Chhattisgarh",
    ...
    public void setUpStates() {
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(this, R.layout.states_item, states);
